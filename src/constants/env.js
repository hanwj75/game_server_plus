...
export const DB3_NAME = process.env.DB3_NAME || "database3";
export const DB3_USER = process.env.DB3_USER || "user3";
export const DB3_PASSWORD = process.env.DB3_PASSWORD || "password3";
export const DB3_HOST = process.env.DB3_HOST || "localhost";
export const DB3_PORT = process.env.DB3_PORT || 3306;
